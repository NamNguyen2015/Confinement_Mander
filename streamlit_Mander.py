...
if selected_option=='Circular':
    ...
    f_yh=st.number_input('Yeilding stress of Transverse reinforcement steel f_yh [MPa]:', value= float(345), min_value=float(0.00) )
    
    f_co=st.number_input('f_co [MPa]', value=34, min_value=float(0.00))
